module.exports = {
  ...
  selectedRoles: [
    // list of roles that are used in this game.
    'percival',
    'morgana',
    'mordred',
    'merlin',
    ...
    missions: [
      {
        ...
        status: 'SUCCESS', // status of mission: NOT_GONE, SUCCESS, FAIL
  ...
  kingOrder: [
    // order for rendering players. first person is always king
    'bridget',
    'wilson',
    'alex',
    'jason',
